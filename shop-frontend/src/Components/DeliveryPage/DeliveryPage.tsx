...
const data: DataType[] = [
  {
    ...
    cities: <div className='cities-list'>
        <h3 className='cities-list-area'>Москва (в пределах МКАД)</h3>
    </div>,
    courierDelivery: <div className='courier-delivery'>
        <p>290 руб</p>
        <p>на след. день</p>
    </div>,
    pickPoint: <div className='pick-point'>
        <p>190 руб</p>
        <p>1-2 дня</p>
    </div>,
    mailPoint: <div className='mail-point'>
  ...
  },
  {
    ...
    cities: <div>
        <p>Москва (за МКАД), Подмосковье до 10 км от МКАД, Владимир, Иваново, Калуга, Кострома, Нижний Новгород,
  ...
  },
  {
    ...
    expandable: 'Expandable',
    cities: <div>
        <p>   Подмосковье - Дубна, Клин, Орехово-Зуево, Коломна, Серпухов. Александров, Альметьевск, Армавир, Балаково,
            ...
            Миасс, Нефтекамск, Нижнекамск, Новочеркасск, Обнинск, Орел, Орск, Пенза, Петрозаводск, Псков,
            Ростов-на-Дону, Рыбинск, Салават, Самара, Саратов, Саранск, Смоленск, Сосновый Бор, Старый Оскол,
            Стерлитамак, Тамбов, Тольятти, Ульяновск, Чебоксары, Череповец</p>
    </div>,
    courierDelivery: <div className='courier-delivery'>
        <p>390 руб</p>
        <p>2-4 дней</p>
  ...
  },
  {
    ...
    expandable: 'Expandable',
    cities: <div>
        <p>Астрахань, Ачинск, Архангельск, Барнаул, Бийск, Владикавказ, Грозный, Екатеринбрг, Кемерово, Красноярск,
  ...
  },
  {
    ...
    expandable: 'Expandable',
    cities: <div>
        <p>Абакан, Братск, Благовещинск, Владивосток, Горно-Алтайск, Иркутск, Кызыл, Назрань, Надым, Нарьян-Мар,
            Нижневартовск, Новый Уренгой, Ноябрьск, Сургут, Улан-Удэ, Чита, Ханты-Мансийск, Хабаровск, Якутск</p>
    </div>,
    courierDelivery: <div className='courier-delivery'>
        <p>590 руб</p>
        <p> 4-7 дней</p>
    ...
    <React.Fragment>
      <div className="container-delivery-page">
        <div className="breadcrumbs-delivery-page">
          <Breadcrumb className='breadcrumbs-component' items={[{ title: <NavLink to={'/'}>Главная</NavLink> }, { title: 'Доставка и оплата' }]} />
        </div>
