      ...
      {products.map((product) => {
        return (
          <div key={product.id} className="bestsellers-gallery">
            <div className="bestseler-product-img">
              <img src={product.image} alt="Фотография продукта" />
            </div>
            <div className="bestseller-product-title-container">
              <span className="bestseller-product-title">{product.title}</span>
            </div>
            <div>
